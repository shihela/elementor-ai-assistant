...
class Elementor_AI_Generator_Widget extends Widget_Base
{
    ...
    protected function _register_controls(): void
    {
        ...
        $this->add_control('eai_generate_button', ['type' => Controls_Manager::BUTTON, 'text' => esc_html__('Generate Idea', 'elementor-ai-assistant'), 'event' => 'eai_assistant:generate']);
        $this->end_controls_section();
    }

    protected function render(): void
    {
        printf('<div class="eai-generator-widget-wrapper"><p>%s</p></div>', esc_html__('Enter your prompt and click "Generate Idea".', 'elementor-ai-assistant'));
    }
}